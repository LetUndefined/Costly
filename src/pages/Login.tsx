  ...
  return (
    <div className="min-h-screen bg-dark flex flex-col justify-between px-6 py-12">
      ...
      <div className="flex flex-col gap-10">
        <div>
          <p className="text-xs tracking-widest uppercase font-bold text-dark-muted mb-3">Welcome back</p>
        ...
        <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
          ...
          <AuthInput label="Password" name="password" type="password" placeholder="••••••••" value={form.password} autoComplete="current-password" onChange={handleChange} />
